...
/**
 * Resolve os problemas comuns das Progressões Aritméticas, como por exemplo,
...
public class ProgressaoAritmetica {
     ...
     * @param primeiroTermo O valor do primerio termo da PA
     * @param razao O valor da razão entre cada termo da PA
     */
    public ProgressaoAritmetica(double primeiroTermo, double razao){
    ...
    public double calcularTermoN(double indiceTermoN){
        return primeiroTermo + ((indiceTermoN - 1) * razao);
    }
    
    /**
     * Calcula e retorna o somatório entre os termos da PA até o termo N. 
     * @param indiceTermoN A posição do termo N procurado
     * @return double
     */
    public double calcularSomatorioAteTermoN(double indiceTermoN){
        return ((primeiroTermo + calcularTermoN(indiceTermoN)) * indiceTermoN) / 2;
    }
